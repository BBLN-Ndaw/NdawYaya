...
void fenetre::OnBas(){
   ...
   if(d_t.Joueur().positionJoueur().numLigne()!=d_t.nbLigne()-1){
...
void fenetre::OnDroite(){
    ...
    if(d_t.Joueur().positionJoueur().numColonne()!=d_t.nbColonne()-1){
...
void fenetre::OnGauche(){
     ...
     if(d_t.Joueur().positionJoueur().numColonne()!=0){
...
void fenetre::OnHG(){
    ...
    if(d_t.Joueur().positionJoueur().numColonne()!=0 && d_t.Joueur().positionJoueur().numLigne()!=0){
...
void fenetre::OnHD(){
    ...
    if(d_t.Joueur().positionJoueur().numColonne()!=d_t.nbColonne()-1 && d_t.Joueur().positionJoueur().numLigne()!=d_t.nbLigne()-1){
